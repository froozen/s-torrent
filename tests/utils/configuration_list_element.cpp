...
class ConfigurationListElementTest : public testing::Test
{
    public:
        ...
        utils::Configuration_list_element config;
};
...
TEST_F ( ConfigurationListElementTest, Reading )
{
    ...
    utils::Configuration_element sub_element = config.get_element ( 4 );
...
TEST_F ( ConfigurationListElementTest, Setting )
{
    ...
    utils::Configuration_element test_element = config.get_element ( 4 );
